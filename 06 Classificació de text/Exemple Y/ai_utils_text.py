...
class ModelConfig:
    def __init__(self, config_file, labels):
        ...
        self.class_labels = labels or ['ham', 'spam']
        ...
        self.category_column = config_file['columns']['categories']
        self.text_column = config_file['columns']['text']
    ...
    def __init__(self, config: ModelConfig):
        ...
        for layer_config in config.layers:
            ...
            if layer_type == 'Embedding':
                ...
                num_out_features = 0
                if layer_config['out_features'] == "unique_categories":
